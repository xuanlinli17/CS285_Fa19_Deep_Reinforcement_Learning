...
class MBAgent(BaseAgent):
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            lower = i * num_data_per_ens
            upper = (i+1) * num_data_per_ens
            observations = ob_no[lower:upper] # TODO(Q1)
            actions = ac_na[lower:upper] # TODO(Q1)
            next_observations = next_ob_no[lower:upper] # TODO(Q1)
